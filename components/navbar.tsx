...
const Navbar = () => {
    ...
    <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 space-x-8 lg:px-8" aria-label="Global">
      <div className="flex">
        <a href="#" className="-m-1.5 p-1.5">
          <span className="sr-only">Your Company</span>
            <div className="text-indigo-700 font-bold text-lg">MY NOTES</div>
            <div className="text-indigo-600 text-xs">Simple & Quick Note Taking</div>
        </a>

      </div>
      <div className="flex lg:flex-1 bg-slate-100 p-2 rounded-md justify-between">
        <input className="bg-slate-100 border-0 outline-0" placeholder="Search here"/>
        <Image src={SearchIcon} alt={"search"}/>

      </div>
      <div className="peer lg:justify-end">
      <div
      className=" flex -space-x-2 overflow-hidden bg-slate-200 rounded-full p-2">
